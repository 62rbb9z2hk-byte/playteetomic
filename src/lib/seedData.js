...
export const USERS = [
  { id: 'u1', name: 'Carlos Martínez', username: 'carlosgolfer', city: 'Sevilla', municipality: 'Sevilla', handicap: 12, bio: 'Golfista apasionado desde hace 10 años. Madrugador empedernido.', initials: 'CM', color: 'from-emerald-500 to-green-700', rounds: 47, fields: 8, rating: 4.8, tags: ['madrugador', 'social', '18 hoyos'] },
  { id: 'u2', name: 'Laura García', username: 'lauragolf', city: 'Madrid', municipality: 'Las Rozas', handicap: 24, bio: 'Nueva en Madrid, buscando grupo fijo para los domingos.', initials: 'LG', color: 'from-amber-500 to-yellow-700', rounds: 23, fields: 5, rating: 4.9, tags: ['social', 'quincenal', 'principiante'] },
  { id: 'u3', name: 'Javier Fernández', username: 'javi_pro', city: 'Barcelona', municipality: 'Sant Cugat del Vallès', handicap: 3, bio: 'Scratch aspirante. Compito en torneos regionales.', initials: 'JF', color: 'from-blue-500 to-indigo-700', rounds: 92, fields: 14, rating: 4.7, tags: ['competitivo', 'scratch', '18 hoyos'] },
  { id: 'u4', name: 'Marta Ruiz', username: 'marta_golf', city: 'Málaga', municipality: 'Marbella', handicap: 18, bio: 'Juego los fines de semana con cualquier nivel. Social ante todo.', initials: 'MR', color: 'from-rose-500 to-red-700', rounds: 31, fields: 6, rating: 5.0, tags: ['social', 'relajada', '9 y 18'] },
  { id: 'u5', name: 'Andrés Sánchez', username: 'andres_tee', city: 'Sevilla', municipality: 'Sevilla', handicap: 7, bio: 'Colecciono campos. 34 en el ranking y subiendo.', initials: 'AS', color: 'from-purple-500 to-violet-700', rounds: 68, fields: 22, rating: 4.6, tags: ['competitivo', 'viajero'] },
  { id: 'u6', name: 'Elena Torres', username: 'elena_t', city: 'Valencia', municipality: 'Valencia', handicap: 31, bio: 'Empecé hace 2 años. Me encanta el ambiente del campo.', initials: 'ET', color: 'from-orange-500 to-amber-700', rounds: 14, fields: 3, rating: 4.8, tags: ['principiante', 'social', 'madrugadora'] },
  { id: 'u7', name: 'Pedro Gómez', username: 'pedro_golf', city: 'Bilbao', municipality: 'Getxo', handicap: 15, bio: 'Fin de semana siempre al campo. Cañas post-ronda obligatorias.', initials: 'PG', color: 'from-teal-500 to-cyan-700', rounds: 55, fields: 9, rating: 4.5, tags: ['social', 'cañas', 'fin de semana'] },
  { id: 'u8', name: 'Sofía Morales', username: 'sofia_golfista', city: 'Madrid', municipality: 'Pozuelo de Alarcón', handicap: 22, bio: 'Organizo torneos benéficos. El golf une personas.', initials: 'SM', color: 'from-pink-500 to-rose-700', rounds: 39, fields: 11, rating: 4.9, tags: ['organizadora', 'torneos', 'social'] },
  { id: 'u9', name: 'Ricardo Blanco', username: 'ricardob', city: 'Sotogrande', municipality: 'Sotogrande', handicap: 1, bio: 'Vivo en el campo. Director en Valderrama los fines de semana.', initials: 'RB', color: 'from-green-400 to-emerald-700', rounds: 180, fields: 30, rating: 4.7, tags: ['scratch', 'competitivo', 'torneo'] },
  { id: 'u10', name: 'Isabel Navarro', username: 'isa_golf', city: 'Cantabria', municipality: 'Pedreña', handicap: 28, bio: 'Las vistas del campo de Pedreña no tienen precio.', initials: 'IN', color: 'from-sky-500 to-blue-700', rounds: 18, fields: 4, rating: 4.8, tags: ['social', 'relajada', 'madrugadora'] },
]
